...
const navigation = [
    ...
    { name: 'Classrooms', href: '/admin/classrooms', icon: FolderIcon },
                ...
                <div className="flex flex-col h-screen">
                    ...
                    <div className="flex items-center px-3 py-4 border-b border-gray-100">
                        <Link href="/admin/dashboard" className="flex items-center">
                            ...
                            <span className={clsx(
                                'ml-3 text-xl font-bold text-blue-600 whitespace-nowrap overflow-hidden transition-all duration-200',
            ...
            <div className="flex-1 flex flex-col min-w-0 lg:ml-16">
                ...
                <header className="sticky top-0 z-30 bg-white border-b border-gray-200 px-6 py-4 flex items-center gap-4">
                    ...
                    <h1 className="text-xl font-bold text-gray-900">
                        {navigation.find(n => pathname?.startsWith(n.href))?.name || 'Admin Portal'}
                    </h1>
                </header>
